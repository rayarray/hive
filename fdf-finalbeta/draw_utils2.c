...
/*   Updated: 2023/05/19 14:52:39 by rleskine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	draw_text(fdf, 6, 1, "ESC to quit");
	draw_text(fdf, 6, 16, "Num +/- to scale height");
	draw_text(fdf, 6, 31, "WASD to scroll");
	draw_text(fdf, 6, 46, "ZX to zoom in/out");
	draw_text(fdf, 6, 61, "QE to rotate");
	draw_text(fdf, 6, 76, "R to reset");
}
